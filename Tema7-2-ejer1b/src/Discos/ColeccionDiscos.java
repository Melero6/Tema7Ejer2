...
public class ColeccionDiscos {
	...
	public void añadir(Disco disc){//añade un disco en la siguiente posicion de la coleccion
	...
	public boolean existeEAN(String id){//Compara el EAN del disco que vamos a añadir, con los que existen en la coleccion.
