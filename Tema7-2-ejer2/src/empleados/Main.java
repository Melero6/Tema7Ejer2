	...
	public static void main(String[] args) {
		...
		do{
			...
			case 6:
				...
				break;
			case 7:
				System.out.print("Escribe el id del empleado del que quieres midicar datos:");
				do{
					id=teclado.nextInt();
					if(!(id<=100&&id>=1))
						System.out.println("Escriba un Valor entre 1 y 100");
